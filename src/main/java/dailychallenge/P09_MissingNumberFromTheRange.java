...
public class P09_MissingNumberFromTheRange {

	/**
	 * Given an array nums containing n distinct numbers in the range [0, n], return
	 * the only number in the range that is missing from the array.
	 * 
	 * [0,n]-->min num starting range , max num ending value
	 * 
	...
	public void testcase1() {
		...
		Assert.assertEquals(2, missingNumUsingBruteForce(arr));
	}
	...
	public void testcase3() {
		...
		Assert.assertEquals(8, missingNumUsingBruteForce(arr));
	}
	...
	private int missingNumUsingBruteForce(int[] arr) {
