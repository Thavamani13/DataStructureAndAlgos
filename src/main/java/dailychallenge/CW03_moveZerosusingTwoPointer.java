...
public class CW03_moveZerosusingTwoPointer {
	...
	public void testcase1() {
		...
		Assert.assertArrayEquals(new int[] { 1, 2, 4, 3, 5, 0, 0, 0 }, moveZeroUsingBruteForce(arr));
	 ...
	 * 
	 */
	private int[] moveZeroUsingBruteForce(int[] arr) {
	...
	private int[] moveZerosUsingTwoPointer(int[] arr) {
